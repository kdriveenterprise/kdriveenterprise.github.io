...
class __TwigTemplate_7fc9888fb8a04d5be2be8696b2b90dc7ff77883f8edf5c760e019f66f96d10c4 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "C:\\xampp\\htdocs\\k-drive\\wp-content\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
