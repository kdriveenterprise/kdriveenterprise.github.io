...
return [
    ...
    'filename' => 'C:/xampp/htdocs/k-drive/wp-content/themes/g5_helium/custom/config/home_-_particles/layout.yaml',
    'modified' => 1611628079,
    'data' => [
        'version' => 2,
        'preset' => [
...
<div>Find out more about using the Layout Manager in our <a href="http://docs.gantry.org/gantry5/configure/layout-manager">documentation</a>.</div>',
    ...
    <blockquote>
        <img src="gantry-theme://images/testimonials/120370597_10208044375302838_5262488093057663609_o.jpg" alt="Avatar" class="g-img-circle" height="120" width="120">
        <h3>"K:\\ Drive is dedicated on helping the community to cope up with the latest technology trends."</h3>
        <footer>Kevin Karl S. Leaño</footer>
    </blockquote>
</div>'
                ]
            ],
