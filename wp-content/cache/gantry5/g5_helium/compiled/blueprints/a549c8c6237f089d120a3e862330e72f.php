...
return [
    ...
    'timestamp' => 1602977741,
    'checksum' => '7a8825c2c17d73c9c1af580298b47c9b',
    'files' => [
        'wp-content/themes/g5_helium/custom/particles' => [
            'particles/contentarray' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/contentarray.yaml',
                'modified' => 1602290744
            ],
            'particles/contentcubes' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/contentcubes.yaml',
                'modified' => 1602290744
            ],
            'particles/copyright' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/copyright.yaml',
                'modified' => 1602907782
            ],
            'particles/element-injector' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/element-injector.yaml',
                'modified' => 1602290744
            ],
            'particles/fixed-header' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/fixed-header.yaml',
                'modified' => 1602290744
            ],
            'particles/menu' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/menu.yaml',
                'modified' => 1602290744
            ],
            'particles/slideshow' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/slideshow.yaml',
                'modified' => 1602290745
            ],
            'particles/uikit' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/uikit.yaml',
                'modified' => 1602290745
            ],
            'particles/wow-js' => [
                'file' => 'wp-content/themes/g5_helium/custom/particles/wow-js.yaml',
                'modified' => 1602290745
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.contentarray.description' => [
                'type' => 'input.text',
                'label' => 'Description',
                'description' => 'Customize the description text.',
                'name' => 'particles.contentarray.description'
            ],
            ...
            'particles.contentcubes.description' => [
                'type' => 'input.text',
                'label' => 'Description',
                'description' => 'Customize the description text.',
                'name' => 'particles.contentcubes.description'
            ],
            'particles.contentcubes.column' => [
                'type' => '_parent',
                'name' => 'particles.contentcubes.column',
                'form_field' => false
            ],
            'particles.contentcubes.column.limit' => [
                'type' => 'input.text',
                'label' => 'Number of Columns',
                'description' => 'Enter the maximum number of columns to display per row.',
                'default' => 2,
                'pattern' => '-?\\d{1,2}',
                'name' => 'particles.contentcubes.column.limit'
            ],
            ...
            'particles.contentcubes.items.*.class' => [
                'type' => 'input.text',
                'label' => 'CSS Classes',
                'description' => 'CSS class name for the item.',
                'name' => 'particles.contentcubes.items.*.class'
            ],
            ...
            'particles.wow-js.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable WOW.js particles.',
                'default' => true,
                'name' => 'particles.wow-js.enabled'
            ],
            'particles.wow-js.offset' => [
                'type' => 'input.text',
                'label' => 'Offset',
                ...
                'default' => '200',
                'name' => 'particles.wow-js.offset'
            ],
            'particles.wow-js.mobile' => [
                'type' => 'select.select',
                'label' => 'Mobile',
        ...
        'nested' => [
            'particles' => [
                'contentarray' => [
                    ...
                    'description' => 'particles.contentarray.description',
                ...
                'contentcubes' => [
                    ...
                    'description' => 'particles.contentcubes.description',
                    'column' => [
                        'limit' => 'particles.contentcubes.column.limit'
                    ],
                    'items' => [
                        '*' => [
                            'name' => 'particles.contentcubes.items.*.name',
                            'class' => 'particles.contentcubes.items.*.class',
                ...
                'element-injector' => [
                    'enabled' => 'particles.element-injector.enabled',
                    'cssselector' => 'particles.element-injector.cssselector',
                    'html' => 'particles.element-injector.html',
                    'twig' => 'particles.element-injector.twig',
                    'filter' => 'particles.element-injector.filter'
                ],
                'fixed-header' => [
                ...
                'wow-js' => [
                    ...
                    'offset' => 'particles.wow-js.offset',
                    'mobile' => 'particles.wow-js.mobile'
                ],
                'contenttabs' => [
